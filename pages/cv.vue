<template>
  <NuxtLayout>
    <div class="mx-auto mt-10">
      <main>
        <h1 class="text-center dark:text-slate-200 hidden">Coming Soon (Under Development)</h1>
        ...
        <div class="cv-timeline">
          ...
          <div class="relative w-full  flex flex-col gap-5 pb-10">
            ...
            <div class="events flex flex-col mt-5">
              <div class="item mt-5" v-for="(item,index) in data.educations" :class="index%2!=0 ? 'flex-row-reverse' : ''">
                <div class="col">
                  <div class="item-header w-full flex justify-between">
                    <div class="flex gap-2">
                      ...
                      <div>
                        ...
                        <a :href="item.organization.website" class="text-sm">{{ item.organization.name }}</a>
                      </div>
                    </div>
                    <div>
                  ...
                  <div class="item-body mt-3">
                    ...
                    <!-- <ContentRendererMarkdown :value="item.description" /> -->
                    <!-- <div class="prose">{{ item.description }}</div> -->
                  </div>
      
                </div>
                <div class="pointer"><div class="pointer-circle"></div></div>
                <div class="col empty">
                </div>
              </div>
            </div>
        ...
        <div class="cv-timeline">
          ...
          <div class="relative w-full  flex flex-col gap-5 pb-10">
            ...
            <div class="events flex flex-col mt-5">
              <div class="item mt-5" v-for="(item,index) in data.experiences" :class="index%2!=0 ? 'flex-row-reverse' : ''">
                <div class="col">
                  <div class="item-header w-full flex justify-between">
                    <div class="flex gap-2">
                      <div class="w-10 h-10  rounded-full flex justify-center items-center">
                        <img :src="item.organization.icon" alt="" />
                      </div>
                      <div>
                        <div class="font-bold">{{ item.title }}</div>
                        <a :href="item.organization.website" class="text-sm">{{ item.organization.name }}</a>
...
.col {
  @apply w-full sm:w-1/3 min-h-[200px] max-h-[600px] p-4 bg-slate-50 dark:bg-slate-700 dark:text-slate-200 rounded-md cursor-pointer;
}
