<template>
  <nav class="w-full py-6 px-9 bg-slate-200 flex justify-between items-center">
    <div class="logo text-2xl font-semibold">
      A<div class="inline-block text-slate-400">A</div>
    </div>
    <ul class=" list-none flex gap-2 text-slate-600 font-thin text-xl">
      <li>
      ...
      <li>
        <nuxt-link to="https://github.com/azimi-ali">
